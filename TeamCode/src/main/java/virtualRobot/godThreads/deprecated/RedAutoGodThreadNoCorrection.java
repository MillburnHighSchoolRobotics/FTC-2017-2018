...
// */
//
//public class RedAutoGodThreadNoCorrection extends GodThread {
...
//            toFirstLine = new ToWhiteLine(true, GodThread.Line.RED_FIRST_LINE, failedFirstSensorSecondTriggered
//                    , exceededMaxDistance, smallCorrection); //Goes to firstLine
//        }else {
//            toFirstLine = new ToWhiteLine(false, GodThread.Line.RED_FIRST_LINE, failedFirstSensorSecondTriggered
...
//                    ,exceededMaxDistance, GodThread.Line.RED_FIRST_LINE, weCanUseSonar);
...
//            toSecondLine = new ToWhiteLine(true, GodThread.Line.RED_SECOND_LINE, failedFirstSensorSecondTriggered
//                    , exceededMaxDistance, smallCorrection);
//        }else {
//            toSecondLine = new ToWhiteLine(false, GodThread.Line.RED_SECOND_LINE, failedFirstSensorSecondTriggered
//                    , exceededMaxDistance, smallCorrection);
//        }
...
//            failedFirstSensorSecondTriggered.set(false);
//            LogicThread firstFail= new CompensateForMiss(CompensateForMiss.TriggerLevel.FIRSTLIGHTFAILS,failedFirstSensorSecondTriggered
//                    ,exceededMaxDistance, GodThread.Line.RED_SECOND_LINE, weCanUseSonar);
//            Thread ff = new Thread(firstFail);
//            ff.start();
//            children.add(ff);
//            delegateMonitor(ff, new MonitorThread[]{});
...
//
//    }
//    private double getLineValue(LogicThread l) {
