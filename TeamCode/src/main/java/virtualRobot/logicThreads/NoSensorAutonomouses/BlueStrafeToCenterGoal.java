...
public class BlueStrafeToCenterGoal extends LogicThread{
    @Override
    public void realRun (){
        ...
        runCommand(new Rotate(-90,0.5,1000));
        runCommand(new Pause(200));
        runCommand(new Translate(900, Translate.Direction.FORWARD, 0, 1, -90, "To Ramp", 1000));
    }
