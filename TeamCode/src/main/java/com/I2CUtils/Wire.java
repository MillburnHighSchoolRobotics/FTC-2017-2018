...
// --------------------------------- CLASS VARIABLES -------------------------------------------
    ...
    private Lock wLock;
    // Lock for Write Cache & request queue
...
// --------------------------------- CLASS INIT AND CLOSE --------------------------------------
    ...
    public void write(byte value) {
        ...
        dCache[dNext++] = value;
        dNext = dNext - 1 == REG_NUMBER ? dNext + 1 : dNext;
    }
    ...
    public void requestFrom(byte regNumber, int regCount) {
        dCache[CACHE_MODE]  = READ_MODE;
        dCache[DEV_ADDR]    = wireDevAddr;
        dCache[REG_NUMBER]  = regNumber;
